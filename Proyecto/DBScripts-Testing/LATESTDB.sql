...
ALTER TABLE MVIALES.T_INDICEECONOMICOS ADD CONSTRAINT T_INDICEECONOMICOS_PK PRIMARY KEY ( CODIGO ) ;
...
ALTER TABLE MVIALES.T_FAMILIAS ADD CONSTRAINT T_FAMILIAS_T_INDICEECONOMICOS_FK FOREIGN KEY ( CODINDICEECONOMICO ) REFERENCES MVIALES.T_INDICEECONOMICOS ( CODIGO ) NOT DEFERRABLE ;

--  ERROR: FK name length exceeds maximum allowed length(30)
ALTER TABLE MVIALES.T_TIPOCAMBIOS ADD CONSTRAINT T_TIPOCAMBIOS_T_INDICEECONOMICOS_FK FOREIGN KEY ( CODINDICEECONOMICO ) REFERENCES MVIALES.T_INDICEECONOMICOS ( CODIGO ) NOT DEFERRABLE ;
