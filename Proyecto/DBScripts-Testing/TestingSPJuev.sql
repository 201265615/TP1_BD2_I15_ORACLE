 ...
 CREATE VIEW FilCotiz_V AS
    SELECT *
    FROM T_ArticulosCotizados;
...
-- TRG_BEF_DEL_COTIZ_INS_HISTO


Create or replace trigger TRG_BEF_DEL_COTIZ_INS_HISTO before delete
...
-- TRG_AFT_INS_PFACT_UPD_ARTIC


Create or replace trigger TRG_AFT_INS_PFACT_UPD_ARTIC after insert
