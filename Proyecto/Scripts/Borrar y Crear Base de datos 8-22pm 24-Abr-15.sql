...
CREATE OR REPLACE FUNCTION MVIALES.SP_LISTARTICULOS
  RETURN types.cursortype
AS
  l_cursor types.cursorType;
BEGIN
  OPEN l_cursor FOR SELECT codigo, descripcion FROM t_articulos;
  RETURN l_cursor;
END;
/
...
IS
      ...
      cursor cursorArticulos is select descripcion from t_articulos;

BEGIN
      open cursorArticulos;
      loop
        fetch cursorArticulos into cod; 
...
IS
  ...
  IS
    SELECT descripcion FROM t_articulos;
BEGIN
  OPEN cursorArticulos;
  LOOP
    FETCH cursorArticulos INTO cod;
