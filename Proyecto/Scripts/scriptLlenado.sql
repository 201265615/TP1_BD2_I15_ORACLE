...
VALUES('FTCO2175','Monitor pantalla plana de 21 pulgadas', 1, 1, 'Pantalla Plana', sysdate, 6, 1, 'admin', 10, 5, 20, 50, sysdate);
INSERT INTO t_articulos(CODIGO, DESCRIPCION, UNDMEDIDA, CODMARCA, MODELO, FECREGISTRO, CODFAMILIA, CODESTARTICULO, CODUSERREGISTRO, CANTIDAD, CANTMAXIMA, CANTMINIMA, PRECIOMERCDOLARES, FECHAACTPRECIO)
VALUES('SL02.8G08ME500SSD','carcaza slim 8 GB RAM, 500 GB disco duro', 1, 2, 'CPU Slim', sysdate, 9, 1, 'admin', 5, 1, 10, 100, sysdate);
INSERT INTO t_articulos(CODIGO, DESCRIPCION, UNDMEDIDA, CODMARCA, MODELO, FECREGISTRO, CODFAMILIA, CODESTARTICULO, CODUSERREGISTRO, CANTIDAD, CANTMAXIMA, CANTMINIMA, PRECIOMERCDOLARES, FECHAACTPRECIO)
VALUES('INCOHO','Impresora color inyeccion de tinta', 1, 1, 'Inyeccion', sysdate, 5, 1, 'admin', 3, 1, 10, 40, sysdate);
INSERT INTO t_articulos(CODIGO, DESCRIPCION, UNDMEDIDA, CODMARCA, MODELO, FECREGISTRO, CODFAMILIA, CODESTARTICULO, CODUSERREGISTRO, CANTIDAD, CANTMAXIMA, CANTMINIMA, PRECIOMERCDOLARES, FECHAACTPRECIO)
VALUES('FP110','Fuente de poder 110V', 1, 5, '110V', sysdate, 9, 1, 'admin', 2, 1, 10, 25, sysdate);
